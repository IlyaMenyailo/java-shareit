...
class ItemDtoJsonTest {
    ...
    void testSerialize() throws IOException {
        ...
        assertThat(jsonString).contains("\"requestId\":10");
        assertThat(jsonString).contains("\"ownerId\":5");
    }
    ...
    @Test
    void testPartialDeserialization() throws IOException {
        String jsonContent = "{\"name\": \"Updated Name\", \"description\": \"Updated Description\"}";
